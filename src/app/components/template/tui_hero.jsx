...
export default function Example() {
  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative isolate px-6 sm:pt-14 lg:px-8 bg-no-repeat bg-center bg-cover" style={{backgroundImage:`url('/images/banner/fireplace-home-banner.webp')`}}>
        {/* <div
          aria-hidden="true"
