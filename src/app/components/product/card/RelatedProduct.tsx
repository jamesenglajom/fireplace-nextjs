    ...
    return <div className="overflow-hidden rounded-md border w-full">
        <div className="w-full flex items-center justify-center h-[230px] overflow-hidden bg-white relative">
            ...
            <div className="absolute top-[10px] right-[10px]">
                <button className="flex justify-center items-center w-[36px] h-[36px] bg-stone-400 rounded-full">
                    <Icon icon="teenyicons:heart-outline" className="text-white text-[20px]" />
                </button>
            </div>
            <div className="absolute bottom-[60px] left-0 rounded-r-full bg-pallete-orange text-white text-[12px] font-bold py-[7px] px-[15px]">ONSALE</div>
        ...
        <div className="flex flex-col gap-[15px] p-[20px]">
            <div>Starting at <span className="text-pallete-green font-bold text-[20px]">$6,659.00</span></div>
            <div className="flex h-[80px] bg-stone-300 my-[15px]">
            ...
            <div className="flex flex-col gap-[5px]">
                <div className="flex items-center gap-[5px]">
                    <div>
                        <Rating value={5} style={{ maxWidth: 80 }}></Rating>
                    </div>
                    <div className="text-[12px]">
                        (5)
                    </div>
                </div>
                <div className="text-pallete-gray text-[12px]">ITEM #77777777</div>
            </div>
