        ...
        <div>
          <div className="border inline-block">
            <input
              ...
              className=" text-sm md:text-base p-[15px] rounded-none outline-none focus:border-theme-300 focus:ring-orange-300 bg-[#f1f1f1] ring:2 border-theme-500 border md:w-[500px]"
            />
            <button className="py-[15px] px-[30px] text-white bg-theme-500 border border-theme-500 text-sm md:text-base">
              Join
            </button>
          </div>
        </div>
